...
function twentysixteen_setup() {
	...
	//Add Gallery Carousel Thumbnail Size

	add_image_size( 'homepage-contact-thumbnail', 538, 230, true );

	// This theme uses wp_nav_menu() in two locations.
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'twentysixteen' ),
		'topMenu'  => __( 'Top Menu', 'twentysixteen' ),
	) );
...
function twentysixteen_scripts() {
	...
	wp_register_style( 'swiper', get_template_directory_uri() . '/lib/swiper/swiper.min.css' );
  wp_register_style( 'font-awesome', get_template_directory_uri() . '/lib/font-awesome/css/font-awesome.min.css' );
	...
	// Theme block stylesheet.
	wp_enqueue_style( 'owlcarousel', get_template_directory_uri() . '/lib/owlcarousel/assets/owl.carousel.min.css', array( 'twentysixteen-style' ), '20181230' );
	// Theme block stylesheet.
	wp_enqueue_style( 'slick-style', get_template_directory_uri() . '/lib/slick/slick.min.css', array( 'twentysixteen-style' ), '20181230' );

	// Theme block stylesheet.
	wp_enqueue_style( 'aos', get_template_directory_uri() . '/lib/aos/aos.css', array( 'twentysixteen-style' ), '20181230' );
	...
	wp_enqueue_script( 'carousel', get_template_directory_uri() . '/lib/owlcarousel/owl.carousel.min.js' );
	wp_enqueue_script( 'slick', get_template_directory_uri() . '/lib/slick/slick.min.js' );
	wp_enqueue_script( 'swiper', get_template_directory_uri() . '/lib/swiper/swiper.min.js' );
	wp_enqueue_script( 'aon', get_template_directory_uri() . '/lib/aos/aos.js' );
	wp_enqueue_script( 'aon', get_template_directory_uri() . '/lib/wow/wow.min.js' );
	wp_enqueue_script( 'paroller', get_template_directory_uri() . '/lib/paroller/jquery.paroller.min.js' );
...
function footer_location(){
	...
	} add_action('widgets_init', 'footer_location');
